		...
		case '/goanimate-rewritten/cc':
			...
			params = {
				flashvars: {
					...
					'theme': 'whiteboard', 'ut': 60, 'type': 'guy', 'appCode': 'go', 'page': '', 'siteId': 'go',
