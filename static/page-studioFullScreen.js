...
module.exports = function (req, res, url) {
	...
	switch (url.pathname) {
		case '/goanimate-rewritten/create-a-terrible-video/command/previewVideoInFullScreen':
			title = 'Make a video';
...
<link rel="stylesheet" href="https://josephcrosmanplays532.github.io/GoAnimate-Rewriten-Files/studio/css/common_combined.css.gz.css">
...
<!-- SharpSpring end -->
     ...
     FILE ARCHIVED ON 18:06:29 Feb 07, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:58:16 Dec 17, 2021.
...
<!--
playback timings (ms):
  LoadShardBlock: 155.245 (3)
  PetaboxLoader3.resolve: 90.964
  CDXLines.iter: 34.985 (3)
  load_resource: 188.769
  exclusion.robots: 157.267
  xauthn.identify: 106.459
  PetaboxLoader3.datanode: 220.329 (4)
  captures_list: 358.217
  RedisCDXSource: 3.908
  esindex: 0.022
  exclusion.robots.policy: 157.243
  xauthn.chkprivs: 50.195
-->`);
	return true;
}
